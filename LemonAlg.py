...
#216 line new_graph_size = 3000 default
...
if __name__=='__main__':
    ...
    #give the delimiter option in the initial files
    parser.add_option("-d", "--delimiter", dest="delimiter", default=' ',
                      help="delimiter of input & output files [default: space]")
    #give the network file
    parser.add_option("-f", "--input network file", dest="network_file", default="../example/lfr/LFR1/graph.txt",
                      help="input file of edge list for clustering [default: example_graphs/amazon/graph]")
    #give the ground truth community file
    parser.add_option("-g", "--input community ground truth file", dest="groundtruth_community_file", default="../example/lfr/LFR1/community.txt",
                      help="input file of ground truth community membership [default: example_graphs/amazon/community]")
    #the output file of the detected community
    parser.add_option("--out", "--output file", dest="output_file", default="../example/lfr/LFR1/output.txt",
                      help="output file of detected community [default: output.txt]")
    #give the seed node set
    parser.add_option("--sd", "--input seed set file", dest="seed_set_file", default="../example/lfr/LFR1/seed.txt",
                      help="input file of initial seed set [default: example_graphs/amazon/seed]")
    #give the minimun community size to be found
    ...
    #give the maximum community size to be found
    parser.add_option("-C", "--maximal community size", dest="max_comm_size", default=50,
    ...
    #give the expand step
    parser.add_option("-e", "--expand step", dest="expand_step", default=1,
                      help="the step of seed set increasement during expansion process [default: 6]")
    #give the initial number of seed node(s)
    ...
    #the initial options(network file, community file, delimiter etc)
...
#    test_comm = np.array([14833, 42658, 43004, 58660 ,14835, 14836, 14837 ,106584, 115338 ,42659 ,58661 ,106585 ,288614 ,106586 ,14838 ,106587 ,302943 ,14839 ,14840 ,302944 ,115339, 106588 ,106589 ,206424 ,106590 ,42660 ,106591, 42661, 115340, 293641, 106592])
    test_comm = np.array([641, 130, 271, 18, 788, 277, 799, 934, 679, 43, 715, 204, 973, 978, 596, 470, 984, 217, 734, 479, 864, 611, 867, 358, 231, 488, 493, 494, 243, 372, 884, 637])
    ...
    F1_score, Precision, Recall = cal_Fscore(detected_comm,new_test_comm)
    print("-----------------------------------------------------------------------")
    print("The F1 score between detected community and ground truth community is: ",F1_score)
    print("-----------------------------------------------------------------------")
    print("The Precision between detected community and ground truth community is: ",Precision)
    print("-----------------------------------------------------------------------")
    print("The Recall between detected community and ground truth community is: ",Recall)
    JIndex = cal_Jaccard(detected_comm,new_test_comm)
    print("-----------------------------------------------------------------------")
    print("The Jaccard Index between detected community and ground truth community is: ",JIndex)
    ...
    with open(output_file,"a") as out:
        ...
        out.write("# Jaccard Index: "+str(JIndex)+'\n')
